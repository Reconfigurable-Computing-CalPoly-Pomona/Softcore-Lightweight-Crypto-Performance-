...
Used to retrieve execution time of a given processor running the encryption

"""
def getExec():
    print ("Starting Program cycle")
    print ("Defined interval: ")
    interval = input()
    print "Num Intervals: ", interval
    startTime = time.clock() # retrieve starting execution time
    startExec(interval)
    stopTime = time.clock() # retrieve stop execution time
    totalTime = stopTime - startTime
    print "Total Execution time: ", totalTime, " seconds for ", interval, " sets"


"""
startExec

ASCON128 Demo example modified to accept user determined intervals

"""
def startExec (interval):  
